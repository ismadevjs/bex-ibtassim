<footer class="site-footer">
    <div class="site-footer__bg" style="background-image: url(front/assets/images/backgrounds/footer-bg-1-1.png);"></div>
    <!-- /.site-footer__bg -->
    <div class="container">
        <div class="row">
            <div class="footer-widget__column footer-widget__about">
                <a href="index.html" class="footer-widget__logo"><img src="front/assets/images/logo-dark.png" width="123" alt=""></a>
            ...
            <div class="footer-widget__column footer-widget__gallery">
                ...
                <ul class="footer-widget__gallery-list list-unstyled">
                    <li><a href="#">
                            <img src="front/assets/images/resources/footer-1-1.jpg" alt="">
                        </a></li>
                    <li><a href="#">
                            <img src="front/assets/images/resources/footer-1-2.jpg" alt="">
                        </a></li>
                    <li><a href="#">
                            <img src="front/assets/images/resources/footer-1-3.jpg" alt="">
                        </a></li>
                    <li><a href="#">
                            <img src="front/assets/images/resources/footer-1-4.jpg" alt="">
                        </a></li>
                    <li><a href="#">
                            <img src="front/assets/images/resources/footer-1-5.jpg" alt="">
                        </a></li>
                    <li><a href="#">
                            <img src="front/assets/images/resources/footer-1-6.jpg" alt="">
                        </a></li>
                </ul><!-- /.footer-widget__links-list list-unstyled -->
            </div><!-- /.footer-widget__column -->
