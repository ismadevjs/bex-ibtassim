...
<div class="card">
    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
      <h4>Amenities : </h4>
        ...
        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#add_user">+ Add Amenities</button>
                    ...
                    <tr>
                        ...
                        <div class="modal fade" id="edit-{{$amn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              ...
                              <form action="{{route('amenities.update')}}" method="POST">
                                <div class="modal-body">
                        ...
                        <div class="modal fade" id="delete-{{$amn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              ...
                              <form action="{{route('amenities.delete')}}" method="POST">
                                @csrf
