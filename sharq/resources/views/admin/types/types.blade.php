...
<div class="card">
    <div class="card-header  bg-dark text-white d-flex justify-content-between align-items-center">
      <h4>types : </h4>
        ...
        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#add_user">+ Add types</button>
                    ...
                    <tr>
                        ...
                        <div class="modal fade" id="edit-{{$amn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              ...
                              <form action="{{route('types.update')}}" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
