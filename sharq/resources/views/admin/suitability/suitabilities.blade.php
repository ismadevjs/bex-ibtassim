...
<div class="card">
    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
      <h4>Suitabilities : </h4>
        ...
        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#add_user">+ Add suitabilities</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add new Suitability</h5>
              <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
        <form action="{{route('suitabilities.store')}}" method="POST">
          <div class="modal-body">
                ...
                <div class="mt-4">
                    <label for="" class="text-dark">icon</label>
                    <input class="form-control" type="text" placeholder="..." name="icon" required>
                </div>
                <div class="mt-4">
                    <label for="" class="text-dark">slug</label>
                    ...
                    <tr>
                        ...
                        <div class="modal fade" id="edit-{{$amn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              ...
                              <form action="{{route('suitabilities.update')}}" method="POST">
                                <div class="modal-body">
                        ...
                        <div class="modal fade" id="delete-{{$amn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              ...
                              <form action="{{route('suitabilities.delete')}}" method="POST">
                                @csrf
    ...
    <div class="card-footer">
        {{ $suitabilities->links('pagination::bootstrap-4') }}
